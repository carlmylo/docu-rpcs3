...
<ul>
<li>Guitarras de Guitar Hero) <strong>son problemáticas para mapear. Si tratas de asignar un botón y todo sale con “U+”, haz click en “Filter Noise” (filtrar ruido)</strong> en el lado izquierdo abajo de la ventana de configuración <strong>y luego intenta mapear otra vez</strong>.</li>
</ul>
